...
author1 = Author.create(name: "Stephen King", hometown: "Scarytown")
author2 = Author.create(name: "Ariana Huffington", hometown: "Newstown")
author3 = Author.create(name: "Horse Ebooks", hometown: "Horsetown")
